...
<head>
    ...
    <title>Editar Cliente - Sistema de Venta</title>
...
<body>
    <div class="container">
        <div class="card">
            ...
            <form id="frm_edit_user" method="post" action="" novalidate>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <a href="<?php echo BASE_URL; ?>clients" class="btn btn-secondary">Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
