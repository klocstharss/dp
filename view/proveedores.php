...
<head>
    ...
    <title>Lista de Proveedores - Sistema de Venta</title>
...
<body>
    <div class="container">
        <h5><i class="bi bi-truck"></i> Lista de Proveedores</h5>
        ...
        <a href="<?php echo BASE_URL; ?>new-proveedor" class="btn btn-success">
    ...
    <script> if (typeof view_proveedores === 'function') { view_proveedores(); } </script>
</body>
</html>
